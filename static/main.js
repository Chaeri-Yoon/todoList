...
var btnChangePassword = document.querySelector('.btn__changePassword');
var passwords = document.querySelector('.input__password');
...
/* harmony export */ });
/* harmony import */ var _toDoList__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(4);
// currentYear: put the text of currently displayed year on it
 // currentMonth: put the text of currently displayed month on it

var currentYear = document.querySelector('.jsYear');
var currentMonth = document.querySelector('.jsMonth');
var dayParent = document.querySelector('.jsDays');
var btnPrevMonth = document.querySelector('.jsBtnPrevMonth');
var btnNextMonth = document.querySelector('.jsBtnNextMonth');
var active = "active"; //displayYear: value of currently displayed year e.g. 2021
...
var displayMonth;
var displayDate;
var getDisplayDate = function getDisplayDate() {
  return displayDate;
};

var setDisplayDate = function setDisplayDate(_year, _month) {
  var _day = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 1;
...
var firstDayOfDisplayDate;
var lastDayOfDisplayDate; //lastDisplayDate: the last date we clicked to see to-Do list

var lastDisplayDate;
var alphabetMonth = ["January", "Fabruary", "March", "April", "May", "June", "July", "August", "September", "October", "November", "December"];

function resetCalender() {
  var thisMonthDays = Array.from(dayParent.querySelectorAll('li'));
  thisMonthDays.forEach(function (thisMonthDay) {
    return dayParent.removeChild(thisMonthDay);
  });
}
...
function getCurrentCalender() {
  ...
  setCalender();
  (0,_toDoList__WEBPACK_IMPORTED_MODULE_0__.resetToDoList)();
}

function getDateKey(_year, _month, _day) {
  var isFirstSetting = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : true;
  return "".concat(_year).concat(_month + 1 < 10 ? "0" + (_month + 1).toString() : _month + 1).concat(_day < 10 ? "0" + _day.toString() : _day);
}
...
function onDateClicked(_button, _key) {
  ...
  var year = parseInt(_key.substring(0, 4));
  var month = parseInt(_key.substring(4, 6));
  var day = parseInt(_key.substring(6, 8));
...
function setFirstAndLastDay() {
  firstDayOfDisplayDate = new Date(displayYear, displayMonth, 1).getDay(); // numOfDays: How many days in this month?

  var numOfDays = new Date(displayYear, displayMonth + 1, 0).getDate();
...
function setCalender() {
  ...
  for (var i = 0; i < Math.trunc(lastDayOfDisplayDate / 7) + 1; i++) {
    var _loop = function _loop(j) {
      if (7 * i + j > lastDayOfDisplayDate) return "break";
      var li = document.createElement('li');
      var button = document.createElement('button');
      var day = 0;
      if (i == 0 && j < firstDayOfDisplayDate) button.innerText = "";else {
        day = 7 * i + j - (firstDayOfDisplayDate - 1);
        button.innerText = day;
      }
      var key = getDateKey(displayYear, displayMonth, day);
      ...
      button.addEventListener('click', function (event) {
        onDateClicked(event.target, key);
      });
...
function onNextMonthButtonClicked() {
  resetCalender();
  displayMonth++;
  if (displayMonth > 11) setDisplayDate(++displayYear, displayMonth - 12);else setDisplayDate(displayYear, displayMonth);
  setCalender();
  (0,_toDoList__WEBPACK_IMPORTED_MODULE_0__.resetToDoList)();
}
...
function onPrevMonthButtonClicked() {
  resetCalender();
  displayMonth--;
  if (displayMonth < 0) setDisplayDate(--displayYear, displayMonth + 12);else setDisplayDate(displayYear, displayMonth);
  setCalender();
  (0,_toDoList__WEBPACK_IMPORTED_MODULE_0__.resetToDoList)();
}
...
/* harmony export */ });
/* harmony import */ var regenerator_runtime_runtime__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(5);
...
/* harmony import */ var _routes__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(33);
/* harmony import */ var _calender__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(3);
...
var toDoForm = document.querySelector('.jsToDoForm');
var enterSpace = document.querySelector('.jsEnterSpace');
var unDone = document.querySelector('.jsToDoList');
var done = document.querySelector('.jsDoneList');
var UNDONE = "undone";
var DONE = "done";
...
var checkTask = function checkTask(event) {
  ...
  var _isUnDone = selectedTask.classList.contains(UNDONE);
  ...
  selectedTask.classList.add(_isUnDone ? DONE : UNDONE); // Parent 옮기기
        ...
        switch (_context.prev = _context.next) {
          case 0:
            ...
            return axios__WEBPACK_IMPORTED_MODULE_1___default()({
              url: _routes__WEBPACK_IMPORTED_MODULE_2__.default.loadToDoList,
              method: "POST",
              data: {
                date: (0,_calender__WEBPACK_IMPORTED_MODULE_3__.getDisplayDate)()
              }
            });
...
var addData = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(taskDescription, isDone) {
    var response, taskID;
...
var updateData = /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3(taskDescription, taskID) {
    var response;
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            _context3.next = 2;
            return axios__WEBPACK_IMPORTED_MODULE_1___default()({
              url: _routes__WEBPACK_IMPORTED_MODULE_2__.default.updateToDoList,
              method: "POST",
              data: {
                date: (0,_calender__WEBPACK_IMPORTED_MODULE_3__.getDisplayDate)(),
                taskDescription: taskDescription,
...
var removeData = /*#__PURE__*/function () {
  var _ref4 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee4(taskID) {
    var response;
      ...
      while (1) {
        switch (_context4.prev = _context4.next) {
          case 0:
            _context4.next = 2;
            return axios__WEBPACK_IMPORTED_MODULE_1___default()({
              url: _routes__WEBPACK_IMPORTED_MODULE_2__.default.deleteToDoList,
              method: "POST",
              data: {
                date: (0,_calender__WEBPACK_IMPORTED_MODULE_3__.getDisplayDate)(),
                taskID: taskID
  ...
  return function removeData(_x5) {
...
axios.spread = __webpack_require__(31); // Expose isAxiosError
...
/* harmony import */ var _changePassword__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(2);
/* harmony import */ var _changePassword__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_changePassword__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _calender__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(3);
/* harmony import */ var _toDoList__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(4);
